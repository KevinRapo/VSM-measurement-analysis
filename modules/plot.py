...
def plotMvsH(separated_pairs, const, original_dataframe, folder_name):
    """
...
def plotMvsT(separated_pairs, const, original_dataframe, folder_name):
    """
...
def plotMeasurementTimeseries(original_dataframe, folder_name):
    """
